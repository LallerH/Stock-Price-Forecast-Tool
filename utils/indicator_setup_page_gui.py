...
class IndicatorSetup_Form(object):
    def setupUi(self, Form):
        ...
        self.label_indicators.setText("Please choose the indicators to be considered as well as the tolerance (basepoints) of them!")
        ...
        self.checkBox_MACDhistchg.setText("Absolute change of MACD HISTOGRAM")
        ...
        self.spinBox_MACDhistchg.setMaximum(10)
        self.spinBox_MACDhistchg.setSingleStep(1)
        self.spinBox_MACDhistchg.setProperty("value", 5)
        ...
        self.Slider_MACDhistchg.setMaximum(10)
        self.Slider_MACDhistchg.setSingleStep(1)
        self.Slider_MACDhistchg.setPageStep(1)
        self.Slider_MACDhistchg.setSliderPosition(5)
        ...
        self.Slider_MACDhistchg.setTickInterval(1)
        ...
        self.spinBox_SMA20chg.setMaximum(20)
        self.spinBox_SMA20chg.setSingleStep(1)
        self.spinBox_SMA20chg.setProperty("value", 10)
        ...
        self.Slider_SMA20chg.setMaximum(20)
        self.Slider_SMA20chg.setSingleStep(1)
        self.Slider_SMA20chg.setPageStep(1)
        self.Slider_SMA20chg.setSliderPosition(10)
        ...
        self.Slider_SMA20chg.setTickInterval(1)
        ...
        self.spinBox_SMA50chg.setMaximum(8)
        self.spinBox_SMA50chg.setSingleStep(1)
        self.spinBox_SMA50chg.setProperty("value", 4)
        ...
        self.Slider_SMA50chg.setMaximum(8)
        self.Slider_SMA50chg.setSingleStep(1)
        self.Slider_SMA50chg.setPageStep(1)
        self.Slider_SMA50chg.setSliderPosition(4)
        ...
        self.Slider_SMA50chg.setTickInterval(1)
