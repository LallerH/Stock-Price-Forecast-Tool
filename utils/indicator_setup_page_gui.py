...
class IndicatorSetup_Form(object):
    def setupUi(self, Form):
        ...
        self.spinBox_SMA20chg.setMaximum(10)
        self.spinBox_SMA20chg.setSingleStep(1)
        self.spinBox_SMA20chg.setProperty("value", 5)
        ...
        self.Slider_SMA20chg.setMaximum(10)
        self.Slider_SMA20chg.setSingleStep(1)
        self.Slider_SMA20chg.setPageStep(1)
        self.Slider_SMA20chg.setSliderPosition(5)
